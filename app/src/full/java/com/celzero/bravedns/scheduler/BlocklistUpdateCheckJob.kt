...
class BlocklistUpdateCheckJob(val context: Context, workerParameters: WorkerParameters) :
    ...
    override suspend fun doWork(): Result {
        ...
        isDownloadRequired(RethinkBlocklistManager.DownloadType.LOCAL)
        isDownloadRequired(RethinkBlocklistManager.DownloadType.REMOTE)
        return Result.success()
    }

    private fun isDownloadRequired(type: RethinkBlocklistManager.DownloadType) {
    ...
    private fun constructDownloadCheckUrl(type: RethinkBlocklistManager.DownloadType): String {
        val timestamp = if (type == RethinkBlocklistManager.DownloadType.LOCAL) {
