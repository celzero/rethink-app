    ...
    val profiles: List<PowerProfileDefinition> =
        listOf(
            ...
            PowerProfileDefinition(
                ...
                bundledArtifactAssetPath = "power/deep-focus-profile.json",
                localBlocklistTagIds = listOf(19, 27, 31, 32, 34, 37, 44, 45, 47, 184),
                sourceProvider = "Rethink DNS",
                sourceSummary =
                    "Curated study profile that fully blocks selected distraction-heavy apps and layers in 10 native Rethink social and gaming blocklists while leaving regular YouTube available.",
                sourceTokens =
                    listOf(
                        "study",
                        "focus",
                        "social-networks-olbat",
                        "facebook",
                        "instagram",
                        "league-of-legends",
                        "gaming-consoles",
