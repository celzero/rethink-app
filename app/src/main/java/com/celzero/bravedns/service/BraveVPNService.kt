...
//import com.rethinkdns.retrixed.rpnproxy.RpnProxyManager.RpnMode
//import com.rethinkdns.retrixed.rpnproxy.RpnProxyManager.rpnMode
import Logger
...
import com.rethinkdns.retrixed.customdownloader.IpInfoDownloader
...
import com.rethinkdns.retrixed.net.manager.ConnectionTracer
import com.rethinkdns.retrixed.receiver.NotificationActionReceiver
import com.rethinkdns.retrixed.receiver.UserPresentReceiver
import com.rethinkdns.retrixed.scheduler.EnhancedBugReport
...
import com.rethinkdns.retrixed.service.ProxyManager.isNotLocalAndRpnProxy
import com.rethinkdns.retrixed.ui.NotificationHandlerActivity
...
import com.rethinkdns.retrixed.util.CoFactory
...
import com.rethinkdns.retrixed.util.Constants.Companion.NOTIF_INTENT_EXTRA_ACCESSIBILITY_NAME
import com.rethinkdns.retrixed.util.Constants.Companion.NOTIF_INTENT_EXTRA_ACCESSIBILITY_VALUE
import com.rethinkdns.retrixed.util.Constants.Companion.PRIMARY_USER
import com.rethinkdns.retrixed.util.Constants.Companion.UID_EVERYBODY
import com.rethinkdns.retrixed.util.Daemons
import com.rethinkdns.retrixed.util.IPUtil
...
import com.rethinkdns.retrixed.util.UIUtils.getAccentColor
...
import com.rethinkdns.retrixed.util.Utilities.isMissingOrInvalidUid
...
class BraveVPNService : VpnService(), ConnectionMonitor.NetworkListener, Bridge, OnSharedPreferenceChangeListener {
    ...
    private val trackedConnMetaData: Cache<String, ConnTrackerMetaData> =
        CacheBuilder.newBuilder()
            .expireAfterWrite(60, TimeUnit.SECONDS) // entry removed 60s after creation/update
        ...
        withContext(CoroutineName("makeVpn") + serializer) {
            ...
            try {
                ...
                if (vpnAdapter == null) {
                    ...
                    Logger.i(LOG_TAG_VPN, "vpn-adapter doesn't exists, create one, fd: $fd, lockdown: $lockdown, protos: $protos")
                    vpnAdapter = GoVpnAdapter(ctx, vpnScope, fd, mtu, opts) // may throw
